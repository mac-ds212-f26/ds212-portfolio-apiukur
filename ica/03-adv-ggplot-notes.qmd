...
- What specific variables (from the data codebook) underlie the visualization? #month and day #cumulative precipitation #Record high and record low #Record
- How do these variables map to aesthetics of the visual elements, eg, position, size, shape, and color of glyphs? #The record high and low use color red to differentiate where the high,lows and normal range start,stop. #color was used on the cumulative precipitation was used to show the difference in the rain record
...
#I partially understand the code but I am not very sure why we use Day==1
