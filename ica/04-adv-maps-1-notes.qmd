...
mn_cities <- st_read("~/Documents/Github/intermediate Data Science/DS212/ica/data/City_And_Township_Population_Centers/City_And_Township_Population_Centers.shp")
mn_water <- st_read("~/Documents/GitHub/intermediate Data Science/DS212/ica/data/Lakes_and_Rivers/Lakes_and_Rivers.shp")

#"~/Documents/GitHub/intermediate Data Science/DS212/ica/data/City_And_Township_Population_Centers/City_And_Township_Population_Centers.shp"
```
...
transform_and_plot <- function(mn_cities, new_crs="EPSG:32133",title="South Carolina") {
    mn_cities |> 
...
#The difference is that is slightly tiltled because of the change in the CRS and Datum
...
- Read the function description at the top. What is the advantage of using this function for making color palettes?
  ...
  #It is used mostly by people with color blindness
